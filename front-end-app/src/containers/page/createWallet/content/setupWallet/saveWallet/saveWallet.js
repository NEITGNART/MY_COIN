    ...
    <>
        ...
        <div className="modal-block">
          <div className="status-modal">
            ...
            <h5 className="status-modal__desc">
              You have created your wallet successfully.
            </h5>
          </div>
      ...
      <div
        className={`basic-button ${
          active ? "button--icon-hidden" : "button--disabled"
        }`}
        onClick={handleDowloadFile}
      >
        Download Keystore File
        <i
          className="fa fa-spinner fa-pulse fa-fw basic-button__icon"
          aria-hidden="true"
        ></i>
      </div>
    </>
...
const contentBlocks = [
  {
    srcImg: Alert,
    title: "Don't Lose It",
    desc: "Be careful, it can not be recovered if you lose it.",
  },
  {
    srcImg: Share,
    title: "Don't Share It",
    desc: "Your funds will be stolen if you use this file on a malicious phishing site.",
  },
  {
    srcImg: Backup,
    title: "Make a Backup",
    desc: "Secure it like the millions of dollars it may one day be worth.",
  },
];
